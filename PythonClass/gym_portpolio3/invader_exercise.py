...
# weight 로드 여부
load_weight = True
load_path = "./save_model1/invader4"
...
class GlobalAgent:
    ...
    def train(self):
        ...
        while True:
            time.sleep(60 * 10)
            cnt += 1
            self.save_model("./save_model1/invader" + str(cnt))
    ...
    def build_model(self):
        ...
        conv = Conv2D(32, (4, 4), strides=(2, 2), activation='relu')(batch1)
        batch2 = BatchNormalization()(conv)
        conv = Flatten()(batch2)

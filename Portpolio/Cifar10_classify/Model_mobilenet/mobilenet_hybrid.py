...
class Mobilenet():
    ...
    def _build_graph(self):
        ...
        with tf.variable_scope(self.name):
            ...
            def fractional_maxpooling(name, l, pooling_ratio, pseudo_random=True, overlapping=True):
                return tf.nn.fractional_max_pool(l,
                    ...
                    with slim.arg_scope([slim.conv2d, slim.separable_convolution2d, slim.fully_connected],
                        ...
                        with slim.arg_scope([slim.batch_norm],
                            ...
                            with slim.arg_scope([slim.dropout],
                                ...
                                l = convlayer('conv0', self.X, 32, self.width_multiplier, 1)
                                print(l)
                                l = fractional_maxpooling('max1', l, [1.0, 1.44, 1.44, 1.0])
                                print(l)
                                ...
                                l = fractional_maxpooling('max4', l, [1.0, 1.44, 1.44, 1.0])
                                print(l)
                                ...
                                l = fractional_maxpooling('max5', l, [1.0, 1.44, 1.44, 1.0])
                                print(l)
                                l = depthwise_convlayer('conv_dw13', l, 1024, self.width_multiplier, 1)

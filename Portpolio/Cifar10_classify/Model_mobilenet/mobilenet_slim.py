                    ...
                    with slim.arg_scope([slim.conv2d, slim.separable_convolution2d, slim.fully_connected],
                        ...
                        with slim.arg_scope([slim.batch_norm],
                            ...
                            with slim.arg_scope([slim.dropout],
                                ...
                                l = depthwise_convlayer('conv_dw8', l, 1024, self.width_multiplier, 2)
                                l = avg_pool2d(l, kernel_size=4, stride=1, padding='VALID', scope='avg_pool9')
                                l = tf.reshape(l, shape=[-1, int(1 * 1 * 1024 * self.width_multiplier)])
                                logits = fclayer('fc10', l, self.label_cnt, out_layer=True)

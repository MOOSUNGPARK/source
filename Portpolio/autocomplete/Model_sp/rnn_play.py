...
import numpy as np
import Portpolio.autocomplete.Model_sp.my_txtutils as my_txtutils
...
with tf.Session() as sess:
    new_saver = tf.train.import_meta_graph('checkpoints/rnn_train_1516063811-0.meta')
    # new_saver.restore(sess, author)
    new_saver.restore(sess, 'checkpoints/rnn_train_1516063811-0')

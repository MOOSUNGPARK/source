...
## Load the data
data_ = ""
with open('C:\\python\\source\\Portpolio\\autocomplete\\data\\shakespeare.txt', 'r') as f:
	data_ += f.read()
data_ = data_.lower()
...
if ckpt_file == "":
	...
	saver.save(sess, "C:\\python\\source\\Portpolio\\autocomplete\\saved\\model.ckpt")
...
for i in range(len(TEST_PREFIX)):
	print(embed_to_vocab(TEST_PREFIX[i], vocab))

...
import time
import numpy as np
import Portpolio.autocomplete.Model_eminem.util as txt
...
Yflat_ = tf.reshape(Yo_, [-1, vocab_size])     # [ BATCHSIZE x SEQLEN, VOCABSIZE ]
...
for x, y_, epoch in txt.rnn_minibatch_sequencer(codetext, BATCHSIZE, SEQLEN, nb_epochs=EPOCHS):
    ...
    if step % _50_BATCHES == 0:
        ...
        txt.print_learning_learned_comparison(i_to_c_vocab, x, y, l, bookranges, bl, acc, epoch_size, step, epoch)

...
from Portpolio.Object_detection.Yolo1.yolo.yolo_net import YOLONet
from Portpolio.Object_detection.Yolo1.utils.timer import Timer
...
def main():
    ...
    parser.add_argument('--data_dir', default="C:\\python\\source\\Portpolio\\Object_detection\\Yolo1\\data", type=str)
    ...
    weight_file = 'C:\\python\\source\\Portpolio\\Object_detection\\Yolo1\\data\\weights\\YOLO_small.ckpt'
    detector = Detector(yolo, weight_file)


    # detect from camera
    cap = cv2.VideoCapture('C:\\python\\source\\Portpolio\\Object_detection\\Yolo1\\test\\dog.mp4')
    detector.camera_detector(cap)

    # detect from image file
    # imname = 'C:\\python\\source\\Portpolio\\Object_detection\\Yolo1\\test\\cat.jpg'

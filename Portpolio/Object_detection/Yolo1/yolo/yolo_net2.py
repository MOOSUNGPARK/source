...
import Portpolio.Object_detection.Yolo1.yolo.config as cfg
    ...
    def build_network(self,
        ...
        with tf.variable_scope(scope):
            with slim.arg_scope([slim.conv2d, slim.fully_connected],
                ...
                print('conv0', net)
                net = slim.conv2d(net, 32, 7, 2, padding='VALID', scope='conv_2')
                print('conv1', net)
                ...
                print('conv2_max', net)
                net = slim.conv2d(net, 64, 1, scope='conv_6')
                print('conv3_1', net)
                net = slim.conv2d(net, 128, 3, scope='conv_7')
                print('conv3_2', net)
                net = slim.conv2d(net, 128, 1, scope='conv_8')
                print('conv3_3', net)
                net = slim.conv2d(net, 128, 3, scope='conv_9')
                print('conv3_4', net)
                net = slim.max_pool2d(net, 2, padding='SAME', scope='pool_10')
                print('conv3_max', net)
                net = slim.conv2d(net, 128, 1, scope='conv_11')
                print('conv4_1', net)
                net = slim.conv2d(net, 128, 3, scope='conv_12')
                print('conv4_2', net)
                # net = slim.conv2d(net, 256, 1, scope='conv_13')
                # print('conv4_3', net)
                # net = slim.conv2d(net, 256, 3, scope='conv_14')
                # print('conv4_4', net)
                # net = slim.conv2d(net, 256, 1, scope='conv_15')
                # print('conv4_5', net)
                # net = slim.conv2d(net, 256, 3, scope='conv_16')
                # print('conv4_6', net)
                # net = slim.conv2d(net, 256, 1, scope='conv_17')
                # print('conv4_7', net)
                # net = slim.conv2d(net, 256, 3, scope='conv_18')
                # print('conv4_8', net)
                # net = slim.conv2d(net, 256, 1, scope='conv_19')
                # print('conv4_9', net)
                # net = slim.conv2d(net, 256, 3, scope='conv_20')
                # print('conv4_10', net)
                net = slim.max_pool2d(net, 2, padding='SAME', scope='pool_21')
                print('conv4_max', net)
                net = slim.conv2d(net, 256, 1, scope='conv_22')
                print('conv5_1', net)
                ...
                print('conv5_7', net)
                net = slim.conv2d(net, 512, 3, scope='conv_29')
                print('conv5_8', net)
                net = slim.conv2d(net, 512, 3, scope='conv_30')
                print('conv5_9', net)

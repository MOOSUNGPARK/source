...
class Mobilenet(object):
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('Mobilenet'):
            ...
            # print('12', l)
            l = depthwise_convlayer('conv_dw13', l, 256, self.width_multiplier, 2)
            # print('13', l)
            ...
            l = fclayer('fc14', l, int(7 * 7 * 256 * self.width_multiplier), 4096)
            l = fclayer('fc15', l, 4096, self.output_size, out_layer=True)
            # print('16', l)
            return l

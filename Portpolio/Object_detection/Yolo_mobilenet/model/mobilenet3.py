...
class Mobilenet(object):
    ...
    def _build_net(self):
        ...
        with tf.variable_scope('Mobilenet'):
            ...
            # print('12', l)
            l = depthwise_convlayer('conv_dw13', l, self.output_size, self.width_multiplier, 2)
            # print('13', l)
            l = avg_pool2d(l, kernel_size=7, stride=1, padding='VALID', scope='avg_pool14')
            # print('14', l)
            l = tf.reshape(l, shape=[-1, self.output_size])
            # print('15', l)
            l = fclayer('fc15', l, self.output_size, self.output_size)
            # print('16', l)
            return l

...
# prelu / Adam / lr = 0.01 / l2_reg_rate = 1e-4
        ...
        with tf.variable_scope(self.name):
            ...
            def add_convlayer(name, l, kernel, channel, stride=1, padding='SAME', pool_yn=True, dropout_yn=True):
                with tf.variable_scope(name):
                    ...
                    # l = self.parametric_relu(l, name+'_relu')
                    if pool_yn:
            ...
            def add_fclayer(name, l, num_input, num_output, out_layer=False):
                # with tf.variable_scope(name):
                #     l = fully_connected(inputs=l, num_outputs=num_output, activation_fn=None,
                #                         weights_initializer=variance_scaling_initializer(),
                #                         weights_regularizer=l2_regularizer(self.l2_reg_rate),

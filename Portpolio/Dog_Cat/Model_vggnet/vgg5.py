...
class Model():
        ...
        with tf.variable_scope(self.name):
            ...
            def conv(l, kernel, channel_out, stride, padding='SAME'):
                return conv2d(inputs=l, num_outputs=channel_out, kernel_size=kernel, stride=stride, padding=padding,
                              activation_fn=self.swish, weights_initializer=variance_scaling_initializer(),
            ...
            def cnn_model():
                ...
                l = add_convlayer('Conv2_sub1', l, 3, 40, pool_yn=False,
                                  dropout_yn=False)  # 60 * 60 * 20 -> 30 * 30 * 40
                ...
                l = add_convlayer('Conv5_sub1', l, 3, 320, pool_yn=False,
                                  dropout_yn=False)  # 4 * 4 * 320 shape= [None, 4, 4, 512]
    ...
    def predict(self, x_test):
        return self.Sess.run(self.softmax_logits,
                             feed_dict={self.X: x_test, self.training: False, self.dropout_rate: 1.0})

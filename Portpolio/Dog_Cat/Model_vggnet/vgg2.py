    ...
    def _build_graph(self):
        with tf.variable_scope(self.name):
            ...
            def cnn_model():
                ...
                l = add_convlayer2('Conv2_sub1', l, 3, 20, 40, pool_yn=False, dropout_yn=False) # 60 * 60 * 20 -> 30 * 30 * 40
                l = add_convlayer2('Conv2_sub2', l, 3, 40, 40)

                l = add_convlayer2('Conv3_sub1', l, 3, 40, 80, pool_yn=False, dropout_yn=False)
                l = add_convlayer2('Conv3_sub2', l, 3, 80, 80)
                print(l)
                l = add_convlayer2('Conv4_sub1', l, 3, 80, 120, pool_yn=False, dropout_yn=False)
                l = add_convlayer2('Conv4_sub2', l, 3, 120, 120, pool_yn=False, dropout_yn=False)
                l = add_convlayer2('Conv4_sub3', l, 3, 120, 120)
                print(l)
                l = add_convlayer2('Conv5_sub1', l, 3, 120, 360, pool_yn=False, dropout_yn=False) # 4 * 4 * 320 shape= [None, 4, 4, 512]
                l = add_convlayer2('Conv5_sub2', l, 3, 360, 360, pool_yn=False, dropout_yn=False)
                l = add_convlayer2('Conv5_sub3', l, 3, 360, 360)

                l = tf.reshape(l, shape = [-1, 4 * 4 * 360]) # flatten
                l = dropout(inputs=l, keep_prob=self.dropout_rate, is_training=self.training)
                l = add_fclayer('Fc1', l, 4 * 4 * 360, 1000)

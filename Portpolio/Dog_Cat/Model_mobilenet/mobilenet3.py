    ...
    def _build_graph(self):
        with tf.variable_scope(self.name):
            ...
            def depthwise_convlayer(name, l, num_filter, width_multiplier, stride):
                ...
                l = slim.batch_norm(l, activation_fn=self.swish, fused=True, is_training=self.training, scope=name+'_batchnorm1')
                ...
                l = slim.batch_norm(l, activation_fn=self.swish, fused=True, is_training=self.training, scope=name+'_batchnorm2')
                return l

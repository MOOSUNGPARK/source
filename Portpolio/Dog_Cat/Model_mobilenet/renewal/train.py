    ...
    def train(self):
        ...
        for epoch in range(self.epochs):
            ...
            for idx in range(0, len(cfg.TRAIN_FILE_LIST), 2):
                ...
                train_x, train_y = train_total_x[0:int(0.8 * train_total_size)], train_total_y[0:int(0.8 * train_total_size)]
                validation_x, validation_y = train_total_x[int(0.8 * train_total_size):], train_total_y[int(0.8 * train_total_size):]

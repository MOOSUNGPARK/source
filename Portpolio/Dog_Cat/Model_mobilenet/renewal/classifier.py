...
from Portpolio.Dog_Cat.Model_mobilenet.renewal.mobilenet_slim import Mobilenet
...
class Classifier():
    def __init__(self, model):
        ...
        # self.saver.restore(self.sess, cfg.CKPT_DIR_PATH + '\\save.ckpt-1590' ) # 8377
        # self.saver.restore(self.sess, cfg.CKPT_DIR_PATH + '\\save.ckpt-2385' ) # 8415
        # self.saver.restore(self.sess, cfg.CKPT_DIR_PATH + '\\save.ckpt-3180' ) # 8537
        # self.saver.restore(self.sess, cfg.CKPT_DIR_PATH + '\\save.ckpt-4770' ) # 8681
        # self.saver.restore(self.sess, cfg.CKPT_DIR_PATH + '\\save.ckpt-5565' ) # 8316
        # self.saver.restore(self.sess, cfg.CKPT_DIR_PATH + '\\save.ckpt-6360' ) # 863
        # self.saver.restore(self.sess, cfg.CKPT_DIR_PATH + '\\save.ckpt-7155' ) # 854
...
def main():
    model = Mobilenet(name='Mobilenet', label_cnt=cfg.LABEL_CNT)
